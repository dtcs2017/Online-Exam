	...
	<body>
					...
					<ul class="nav nav-inline admin-nav">
						...
						<li class="active"><a href="admin/user/index" class="icon-user"> 用户</a>
						    <ul>
								...
								<li><a href="#">教师管理</a></li>
								<li><a href="#">学生管理</a></li>
								<li><a href="admin/user/group">用户组</a>
							</ul>
						</li>
		...
		<div class="admin">
			<form method="post">
				<div class="panel admin-panel">
					...
					<table>
					<tr>
					<td class="my_td">用户名:<input type="text" name="username" class="my_input">  </td>
                    <td class="my_td">邮箱:<input type="text" name="email" class="my_input">  </td>
					...
					<table class="table table-hover">
						...
						<tr>
							...
							<td>${x.gender}</td>
							<td>${x.email}</td>
							<td><fmt:formatDate value="${x.regtime}" type="both"/></td>
							<td><a class="button border-blue button-little" href="user/update?id=${x.id}">修改</a> <a class="button border-yellow button-little" style="cursor:pointer;" onclick="doDelete(${x.id})">删除</a></td>
						</tr>
						</c:forEach>
					</table>
					...
					<li><a href="admin/user/index?pageNum=${pageBean.thisPageNumber+1}">下一页</a></li>
					<li><a href="admin/user/index?pageNum=${pageBean.lastPageNumber}">尾页</a></li>
					</c:if>
					<c:if test="${pageBean.thisPageNumber>1 && (pageBean.thisPageNumber<pageBean.lastPageNumber)}">
					<li><a href="admin/user/index?pageNum=1">首页</a></li>
					<li><a href="admin/user/index?pageNum=${pageBean.thisPageNumber-1}">上一页</a></li>
					<li><a href="admin/user/index?pageNum=${pageBean.thisPageNumber+1}">下一页</a></li>
					<li><a href="admin/user/index?pageNumr=${pageBean.lastPageNumber}">尾页</a></li>
					</c:if>			
		...
		<div class="hidden">
			...
			function doDelete(id1){
				if(confirm('确认删除?')){
							$.ajax({
						        url: "admin/user/doDelete.action",
						        type: "post",
						        data: {id:id1},
