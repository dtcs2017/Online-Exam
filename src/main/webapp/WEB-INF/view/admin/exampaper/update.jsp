				...
				<div class="admin-navbar">
					...
					<ul class="nav nav-inline admin-nav">
						...
						<li class="active"><a href="admin/exampaper/index" class="icon-shopping-cart"> 试卷</a>
						    <ul>
								<li><a href="#">创建试卷</a></li>
								<li class="active"><a href="#">修改试卷</a></li>
							</ul>
						</li>
...
<div class="admin">
    ...
    <input type="hidden" id="updateid" value="${id}">
				<div class="panel admin-panel">
					...
					<form method="post" action="exampaper/index">
					<table>
					<tr>
...
<div class="hidden">
			...
			var checkedIds="";//翻页保存选中的id
			 ...
			 $(function () {
		            ...
		            $.post("admin/exampaper/questionlist.action", null, function (data) {
		            ...
		            PageClick = function (pageIndex, total, pageS, spanInterval) {
		                $.ajax({
		                    url: "admin/exampaper/questionlist.action",
		...
		for (var i =0; i < data.thisPageElements.length; i++) {
		                            table.append(
		                                ...
		                                +"</td><td>"+
		                                data.thisPageElements[i].name
		                                +"</td><td>"+
		                                data.thisPageElements[i].type
		                                +"</td><td>"+
		                                data.thisPageElements[i].points
		                                +"</td></tr>")
		                                );
		                        } //for
		...
		getChecked();
		       ...
		       function doUpdate(){
		    	   ...
		    	   $.ajax({
	                    url: "admin/exampaper/doUpdate.action",
